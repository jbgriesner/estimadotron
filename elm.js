...
{
	if (region.ch.aA === region.cO.aA)
	{
		return 'on line ' + region.ch.aA;
	}
	return 'on lines ' + region.ch.aA + ' through ' + region.cO.aA;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dK: 'hidden', dB: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dK: 'mozHidden', dB: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dK: 'msHidden', dB: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dK: 'webkitHidden', dB: 'webkitvisibilitychange' }
		: { dK: 'hidden', dB: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		dp: {
			dr: _Browser_window.pageXOffset,
			ds: _Browser_window.pageYOffset,
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cR: fragment, cT: host, c5: path, c7: port_, da: protocol, db: query};
	});
...
var $author$project$Main$Model = function (estimates) {
	return {aT: estimates};
};
var $author$project$Main$initialModel = $author$project$Main$Model(_List_Nil);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$Estimate = $elm$core$Basics$identity;
var $author$project$Main$emptyEstimate = {cM: '', dU: 0, dV: 0};
	...
	function (msg, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					aT: A2($elm$core$List$cons, $author$project$Main$emptyEstimate, model.aT)
				}),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$AddEmptyEstimate = 0;
var $aforemny$material_components_web_elm$Material$Button$Internal$Config = $elm$core$Basics$identity;
var $aforemny$material_components_web_elm$Material$Button$config = {bn: _List_Nil, bz: false, aw: false, ay: $elm$core$Maybe$Nothing, bK: $elm$core$Maybe$Nothing, bQ: $elm$core$Maybe$Nothing, b_: $elm$core$Maybe$Nothing, ck: $elm$core$Maybe$Nothing, aG: true, bj: false};
	...
	return A2(
		...
		function () {
			...
			if (!_v1.$) {
				if (!_v1.a.$) {
					var node = _v1.a.a.a3;
					var attributes = _v1.a.a.aN;
					var nodes = _v1.a.a.a4;
					return $elm$core$Maybe$Just(
						A2(
							node,
							A2(
...
var $aforemny$material_components_web_elm$Material$List$config = {bn: _List_Nil, bq: false, bz: false, a_: true, be: true, co: false, eh: false, cu: false};
...
var $aforemny$material_components_web_elm$Material$List$list = F3(
	function (config_, firstListItem, remainingListItems) {
		var ripples = config_.be;
		var interactive = config_.a_;
		var additionalAttributes = config_.bn;
...
var $aforemny$material_components_web_elm$Material$Button$button = F3(
	function (variant, config_, label) {
		...
		var additionalAttributes = innerConfig.bn;
		var touch = innerConfig.aG;
		var href = innerConfig.ay;
		var disabled = innerConfig.aw;
...
var $aforemny$material_components_web_elm$Material$Button$setOnClick = F2(
	function (onClick, _v0) {
		...
		return _Utils_update(
			config_,
			{
				b_: $elm$core$Maybe$Just(onClick)
			});
	});
...
var $author$project$Main$viewEstimate = function (_v0) {
	var e = _v0;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(e.cM)
					]),
				_List_Nil),
...
var $author$project$Main$viewEstimates = function (m) {
	return A2($elm$core$List$map, $author$project$Main$viewEstimate, m.aT);
};
var $author$project$Main$view = function (model) {
	var estimates = $elm$core$List$reverse(
		A2(
			$elm$core$List$cons,
			$author$project$Main$viewAddButton,
			$author$project$Main$viewEstimates(model)));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
		...
		_List_fromArray(
			[
				...
				A2($aforemny$material_components_web_elm$Material$Button$setOnClick, 0, $aforemny$material_components_web_elm$Material$Button$config),
				'+1'),
				A2($elm$html$Html$div, _List_Nil, estimates),
				A2(
				$aforemny$material_components_web_elm$Material$Button$raised,
				A2($aforemny$material_components_web_elm$Material$Button$setOnClick, 0, $aforemny$material_components_web_elm$Material$Button$config),
				'-1')
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		ec: $elm$core$Basics$always($elm$core$Platform$Sub$none),
